...
OLLAMA_MODELS=("phi" "mistral" "gemma:2b" "mistral:7b-instruct-v0.2-q4_K_M")
...
async def ask_all_documents(question: str):
    ...
    try:
        ...
        return {
            "answer": response,
            "searched_documents": list(vector_stores.keys())
        }
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
# Ollama Connection
# OLLAMA_HOST=0.0.0.0 # OPENS OLLAMA SERVER TO REQUESTS FROM ANY SOURCE
OLLAMA_PORT=11434
